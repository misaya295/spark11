...
object SprarkStreaming02_FileDataSource {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val fileDStream: DStream[String] = stramingContext.textFileStream("test")


    //将采集的数据扁平化
    val wordStream: DStream[String] = fileDStream.flatMap(line => line.split(" "))
